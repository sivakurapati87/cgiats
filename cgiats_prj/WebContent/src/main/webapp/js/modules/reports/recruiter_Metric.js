...
/*-*************************** GET DATA FOR REPORT STARTS HERE********************************************-*/
		...
		$scope.getGridData = function(){
			...
			$scope.hitRatioData = {year: $scope.yearforReport, month: $scope.monthforReport =='' ? null : $scope.monthforReport, dmName: $scope.dm.id,isFromRecMetric:true};
			var obj = {year: $scope.yearforReport, month: $scope.monthforReport =='' ? null : $scope.monthforReport, dmName: $scope.dm.id, status:'STARTED',isFromRecMetric:true};
